...
import {
  MessageSquare, Building2, Zap, Clock, ArrowRight,
  CheckCircle2, Mail, Shield, ExternalLink, Bot,
} from 'lucide-react'
    ...
    <div>
      ...
      <div className="dash-card" style={{ marginBottom: 24 }}>
        ...
        {[
          ...
          { label: 'Activate Alfred', done: false, icon: Bot, action: () => router.push('/dashboard/onboarding') },
  ...
  return (
    <div>
      <motion.div
        ...
        className="dash-card dash-card-glow"
        style={{
          marginBottom: 24, display: 'flex', alignItems: 'center', gap: 16, padding: '16px 20px',
      ...
      >
        ...
        <span className="dash-status active"><span className="dash-status-dot" />Running</span>
      </motion.div>
      ...
      >
        <h2 style={{ fontSize: 14, fontWeight: 600, color: 'var(--dash-text)', fontFamily: 'inherit', marginBottom: 16 }}>Recent Activity</h2>
...
export default function Overview() {
  // TODO: Wire to Convex — const tenant = useQuery(api.tenants.get)
