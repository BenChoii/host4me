    ...
    <div className="w-screen font-sans">
      ...
      <section className="h-screen flex flex-col items-center justify-center px-6 text-center">
        <motion.div 
          ...
          className="max-w-4xl"
        >
          <div className="inline-block px-4 py-1.5 mb-6 rounded-full border border-[#f27d26]/30 bg-[#f27d26]/10 text-[#f27d26] text-xs font-bold tracking-widest uppercase">
      ...
      <section className="h-screen flex items-center justify-start px-12 md:px-24">
        <motion.div 
          ...
          className="max-w-xl"
        >
          <div className="text-[#f27d26] font-bold mb-4 tracking-widest uppercase text-sm">Personalization</div>
          <h2 className="text-5xl md:text-7xl font-display font-bold mb-6 leading-tight">
            Your Voice, <br />
            <span className="text-[#f27d26]">Automated.</span>
          </h2>
      ...
      <section className="h-screen flex items-center justify-end px-12 md:px-24">
        ...
        >
          <div className="text-[#f27d26] font-bold mb-4 tracking-widest uppercase text-sm">Availability</div>
          <h2 className="text-5xl md:text-7xl font-display font-bold mb-6 leading-tight">
            Always On. <br />
            <span className="text-[#f27d26]">Always Ready.</span>
          </h2>
          <p className="text-xl text-gray-400 font-light leading-relaxed mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl w-full">
          {[
            ...
            <motion.div 
              ...
              className="p-8 rounded-3xl bg-white/5 border border-white/10 hover:border-[#f27d26]/50 transition-colors group"
            >
              <div className="text-5xl font-display font-black text-white/10 group-hover:text-[#f27d26]/20 transition-colors mb-4">{item.step}</div>
      ...
      <section className="h-screen flex flex-col items-center justify-center px-6 text-center relative overflow-hidden">
        ...
        >
          <h2 className="text-6xl md:text-8xl font-display font-bold mb-8 tracking-tighter">
            READY TO <br />
            <span className="text-[#f27d26]">AUTOMATE?</span>
          </h2>
